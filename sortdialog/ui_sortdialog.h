...
**
** Created: Mon Apr 1 21:05:44 2013
...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        cancekButton = new QPushButton(SortDialog);
        cancekButton->setObjectName(QString::fromUtf8("cancekButton"));

        verticalLayout->addWidget(cancekButton);
        ...
        QWidget::setTabOrder(okButton, cancekButton);
        QWidget::setTabOrder(cancekButton, moreButton);

        retranslateUi(SortDialog);
        QObject::connect(okButton, SIGNAL(clicked()), SortDialog, SLOT(accept()));
        QObject::connect(cancekButton, SIGNAL(clicked()), SortDialog, SLOT(reject()));
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        cancekButton->setText(QApplication::translate("SortDialog", "Cancel", 0, QApplication::UnicodeUTF8));
